...
var profile = {
    classic: {
        ...
        serial: [["Монитор порта(Serial)", "Serial"], ["Канал UART (Serial1)", "Serial1"]],
        speed: [["9600", "9600"], ["38400", "38400"], ["57600", "57600"], ["74880", "74880"], ["115000", "115000"]],
        port: [["1", ["13", "A3"]], ["2", ["10", "A10"]], ["3", ["9", "A9"]], 
                ["4", ["19", "A1"]], ["5", ["1", "0"]], ["6", ["18", "A0"]],
                ["7", ["3", "2"]], ["8", ["20", "A2"]], ["9", ["3", "2"]]],
        servo: [
            ["servo1", "servo1"],
            ["servo2", "servo2"]
...
;(function (root, factory) {
    ...
    let type_variables = {
        arduino: {
            type: [["Integer", "int"], ["Boolean", "bool"], ["Float", "float"]]
        },
        js: {}
    };
    type_variables["default"] = type_variables.arduino;
    ...
    Blockly.Blocks.lists_getIndex = {
        init: function () {
            ...
            a ? (this.appendValueInput("AT").setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]), Blockly.Msg.ORDINAL_NUMBER_SUFFIX &&
    ...
    Blockly.Blocks.lists_setIndex = {
        init: function () {
            ...
            this.removeInput("AT");
            this.removeInput("ORDINAL", !0);
            a ? (this.appendValueInput("AT").setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL").appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput("AT");
            var b = new Blockly.FieldDropdown(this.WHERE_OPTIONS, function (c) {
                var d = "FROM_START" == c || "FROM_END" == c;
                if (d != a) {
                    var e = this.getSourceBlock();
    ...
    Blockly.Blocks.lists_getSublist = {
        init: function () {
            ...
            b ? (this.appendValueInput("AT" + a).setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL" + a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) :
        ...
        init: function () {
            ...
            this.appendValueInput("VALUE")
                ...
                .appendField(new Blockly.FieldDropdown([
                        ...
                        ["нечетное число?", "jnk"],
                        ["целое число?", "jkn"],
                        ["положительное число?", "jkn"],
                        ["отрицательное число?", "jkn"],
                        ["делится нацело на заданное в блоке число?", "jkn"]
                    ]), "QUEST");
    ...
    Blockly.Blocks.loops_break = {
        init: function() {
            ...
            this.appendDummyInput()
                .appendField("Прервать цикл");
            this.setTooltip("Блок выполняет выход из цикла, независимо от выполнения условий или числа повторений действий, помещенных в цикл.");
    ...
    Blockly.defineBlocksWithJsonArray([{
        ...
        output: ["Int", "Float", "Number", "unsigned int", "long", "double", "Char", "unsigned char"],
        ...
        message0: "%1 %2 %3",
        args0: [{type: "input_value", name: "A", check: ["Int", "Float", "Number", "unsigned int", "long", "double"]}, {
            type: "field_dropdown",
            name: "OP",
        ...
        }, {type: "input_value", name: "B", check: ["Int", "Float", "Number", "unsigned int", "long", "double"]}],
        inputsInline: !0,
        output: ["Int", "Float", "Number", "unsigned int", "long", "double"],
        style: "math_blocks",
        ...
        args0: [{
            ...
            {type: "input_value", name: "NUM", check: ["Int", "Float", "Number", "unsigned int", "long", "double"]}],
        output: ["Int", "Float", "Number", "unsigned int", "long", "double"],
        style: "math_blocks",
        ...
        message0: "%1 %2",
        args0: [{type: "input_value", name: "NUMBER_TO_CHECK", check: ["Int", "Float", "Number", "unsigned int", "long", "double"]},
            {
                type: "field_dropdown",
                name: "PROPERTY",
        ...
        args0: [{
            ...
            check: ["Int", "Float", "Number", "unsigned int", "long", "double"]
        }],
        output: ["Int", "Float", "Number", "unsigned int", "long", "double"],
        style: "math_blocks",
        ...
        args0: [{type: "input_value", name: "DIVIDEND", check: ["Int", "Number", "unsigned int"]}, {
            type: "input_value",
            name: "DIVISOR",
            check: ["Int", "Number", "unsigned int"]
        }],
        inputsInline: !0,
        output: ["Int", "Float", "Number", "unsigned int", "long", "double"],
        style: "math_blocks",
    ...
    Blockly.Constants.Math.IS_DIVISIBLEBY_MUTATOR_MIXIN = {
        mutationToDom: function () {
            ...
            a ? b || this.appendValueInput("DIVISOR").setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]) : b && this.removeInput("DIVISOR")
        }
    };
    ...
    Blockly.Blocks.math_whole_part_division = {
        helpUrl: "",
        init: function () {
            this.setStyle("math_blocks");
            this.appendValueInput("NUMBER1")
                .setCheck(["Int", "Number", "unsigned int"])
                .appendField("Целое от");
            this.appendValueInput("NUMBER2")
                .setCheck(["Int", "Number", "unsigned int"])
                .appendField(":");
            this.setInputsInline(true);
            this.setOutput(!0, ["Int", "Float", "Number", "unsigned int", "long", "double"]);
            this.setTooltip('Блок возвращает число, представляющее собой целочисленный результат деления двух чисел, вставленных в соответствующие поля. Эти числа могут быть вставлены, как в виде блоков переменных, так и в виде числовых блоков в зависимости от решаемой в программе задачи. Результат выполненной операции присваивается какой-либо переменной. При этом следует помнить о необходимости соответствия результата вычисления типу переменной, которой он присваивается.');
        }
    };
    Blockly.Blocks.math_boolean_in_numeric = {
        helpUrl: "",
        init: function () {
            this.setStyle("math_blocks");
            this.appendValueInput("VAL", "Boolean")
                .appendField("Преобразование логического значения в число");
            this.setOutput(!0, ["Int", "Float", "Number", "unsigned int", "long", "double"]);
            this.setTooltip('Basic digital input');
            this.setTooltip("Блок выполняет преобразование присоединенного справа логического значения в число. Так, значение «Истина» (true) будет преобразовано в число 1, а значение «Ложь» (false) в число 0. Результат преобразования присваивается какой-либо переменной. При этом должно быть соблюдено его соответствие типу переменной, которой он присваивается.")
        }
    };
    Blockly.Blocks.math_increment_and_decrement = {
        helpUrl: "",
        init: function () {
            this.setStyle("math_blocks");
            this.appendValueInput("NUM")
                .setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"])
            this.appendDummyInput()
                .appendField(new Blockly.FieldDropdown([["++", "++"], ["--", "--"]]), "INC_DEC");    
            this.setInputsInline(true);
            this.setPreviousStatement(!0, null);
            this.setNextStatement(!0, null);
            var b = this;
            this.setTooltip(function () {
                var c = b.getFieldValue("INC_DEC");
                var e = "Ошибка описания";
                switch (c) {
                    case "++":
                        e = "Блок увеличивает или уменьшает (в зависимости от выбора операции в выпадающем меню) на 1 значение числовой переменной. То есть выполняет инкрементирование или декрементирование переменной.";
                        break;
                    case "--":
                        e = "Блок увеличивает или уменьшает (в зависимости от выбора операции в выпадающем меню) на 1 значение числовой переменной. То есть выполняет инкрементирование или декрементирование переменной."
                }
    ...
    Blockly.Blocks.math_one_action = {
        helpUrl: "",
        init: function () {
            this.setStyle("math_blocks");
            ...
            var b = this;
            this.setTooltip(function () {
                var c = b.getFieldValue("ACTION");
                var e = "Ошибка описания";
                switch (c) {
                    case "+=":
                        e = "Блок выполняет математические операции с переменной, помещенной в левое поле, с использованием числа, расположенного в правом поле и присваивает результат операции той же переменной, над которой выполнялась операция. Тип операции выбирается с помощью выпадающего меню. Например, результатом работы блока при выборе операции *= будет увеличение значения переменной в количество раз, указанное в правом поле. При выборе операции /= значение переменной будет уменьшено во столько же раз, сколько указано в правом поле.";
                        break;
                    case "-=":
                        e = "Блок выполняет математические операции с переменной, помещенной в левое поле, с использованием числа, расположенного в правом поле и присваивает результат операции той же переменной, над которой выполнялась операция. Тип операции выбирается с помощью выпадающего меню. Например, результатом работы блока при выборе операции *= будет увеличение значения переменной в количество раз, указанное в правом поле. При выборе операции /= значение переменной будет уменьшено во столько же раз, сколько указано в правом поле.";
                        break;
    ...
    Blockly.Blocks.math_random = {
        ...
        init: function () {
            ...
            this.appendValueInput("MIN")
                .appendField("Случайное число: мин")
                .setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]);
            this.appendValueInput("MAX")
                .appendField("макс")
                .setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]);
            this.setInputsInline(true)
            this.setOutput(["Int", "Float", "Number", "unsigned int", "long", "double"]);
            this.setTooltip("Блок генерирует случайное целое число из диапазона, границы которого задаются числами или значениями переменных, помещенных в соотвествующие поля, обозначенные «мин» и «макс». Это случайное число присваивается какой-либо переменной. При этом обязательно соблюдение его соответствия типу переменной, которой он присваивается.")
        }
    };
    ...
    Blockly.Constants.Math.LIST_MODES_MUTATOR_MIXIN = {
        updateType_: function (a) {
            "MODE" == a ? this.outputConnection.setCheck("Array") : this.outputConnection.setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"])
        }, mutationToDom: function () {
            var a = Blockly.utils.xml.createElement("mutation");
    ...
    Blockly.Blocks.inout_initBasis = {
        init: function () {
            this.setColour("#964b00");
            this.appendDummyInput()
                .appendField("Инициализация контактов (пинов) контроллера")
                .appendField("«Вертор Базис»");
            this.setPreviousStatement(!0, null);
            this.setNextStatement(!0, null);
            this.setTooltip("Блок выполняет первоначальную настройку контактов контроллера «Вертор Базис», а именно настраивает все его линии в режим «Выход» и устанавливает на них напряжение, соответствующее логическому «0». Это делается для противодействия наводкам и дрейфу напряжения на контактах, к которым ничего не подключено. Таким образом, исключается самопроизвольное свечение индикаторов на контактах (пинах), к которым не подключены никакие устройства. Индикаторы работают только на используемых контактах.")
        }
    };
        ...
        helpUrl: "",
            init: function () {
                ...
                this.appendValueInput("STR")
                    .appendField("из строки")
                    .setCheck("String");
                this.appendValueInput("FROM")
                    .appendField("выбрать символы с номерами от ")
                    .setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]);
                    this.appendValueInput("TO")
                    .appendField("до")
                    .setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]);
                this.setTooltip("Блок возвращает текстовую строку, которая представляет собой фрагмент, вырезанный из строки, помещенной в левое поле, из той ее части, которая задается номерами начального и конечного символа. При этом отсчет номеров символов в исходной строке выполняется с нулевого значения.")
                this.setInputsInline(true);
    ...
    Blockly.Blocks.text_equals = {
        ...
        init: function () {
            this.setStyle("text_blocks");
            this.appendDummyInput()
                .appendField("проверка равенства строк");
            ...
            this.setInputsInline(true);
            this.setOutput(!0, "Boolean");
            this.setTooltip('Блок выполняет сравнение двух текстовых строк, помещенных в соответствующие поля. В случае полного символьного совпадения строк (по количеству, местоположению, наличию пробелов и совпадению символов) блок возвращает логическую 1 («Истина», true). При наличии несоответствия по одному или большему количеству символов он возвращает логический 0 («Ложь», false).');
        }
    };
    ...
    Blockly.Constants.Text.TEXT_CHARAT_MUTATOR_MIXIN = {
        mutationToDom: function () {
            ...
            this.removeInput("ORDINAL", !0);
            a && (this.appendValueInput("AT").setCheck(["Int", "Float", "Number", "unsigned int", "long", "double"]), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL").appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX));
    ...
    Blockly.Blocks.variables_add = {
        init: function() {
            ...
            this.appendDummyInput()
                .appendField("Объявить переменную")
                .appendField("Тип:")
                .appendField(new Blockly.FieldDropdown(type_variables["default"].type), "TYPE")
