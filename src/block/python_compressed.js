...
;(function (root, factory) {
    ...
    Blockly.Python.finish = function (a) {
        ...
        this.nameDB_.reset();
        for (d in Blockly.Python.setups_) s.push(Blockly.Python.setups_[d]);
        return (b.join("\n") + "\n" + s.join("\n") + "\n\n" + c.join("\n\n")).replace(/\n\n+/g, "\n\n").replace(/\n*$/, "\n\n\n") + a
    };
    ...
    Blockly.Python.controls_for = function (a) {
        ...
        if (Blockly.isNumber(c) && Blockly.isNumber(d) &&
            Blockly.isNumber(e)) c = Number(c), d = Number(d), e = Math.abs(Number(e)), 0 === c % 1 && 0 === d % 1 && 0 === e % 1 ? (c <= d ? (d++, a = 0 == c && 1 == e ? d : c + ", " + d, 1 != e && (a += ", " + e)) : (d--, a = c + ", " + d + ", -" + e), a = "range(" + a + ")") : (a = c < d ? k() : h(), a += "(" + c + ", " + d + ", " + e + ")"); else {
            var m = function (g, l) {
    ...
    Blockly.Python.procedures_defreturn = function (a) {
        ...
        var k = Blockly.Python.statementToCode(a, "STACK"), h = Blockly.Python.valueToCode(a, "RETURN",
            Blockly.Python.ORDER_NONE) || "", m = "";
        k && h && (m = f);
